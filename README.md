<h1 style="text-align: center;">Jeffrey Seathrún Sardina</h1>
<h3 style="text-align: center;">Graphs & Machine Learning | Bioinformatics | Research | Gaeilge | Privacy</h3>
...
Hello, I'm Jeffrey! I am a machine learning researcher focussing on knowledge graphs and bioinformatics with PhD in Computer Science from Trinity College Dublin. I have a M.Sc. in Data Science from Trinity College Dublin, and a B.Sc. in Bioinformatics from the University of California, San Diego. My research centers on the concept of "Structural Alignment" -- that is, how the structure of a knowledge graph can be used to directly make inferences about it (such as link prediction), without using embeddings. I have also done work on modelling biological context in knowledge graph embeddings (the [NamE](https://ieeexplore.ieee.org/abstract/document/10782639) system) and on building up a terminological database of AI / ML terms in the Irish language (the [Foclóir Tráchtais](https://focloir-riomheolaiochta.github.io/)). I also have a keen interest in online privacy, and contribute to open-source efforts in this area.
...
- Liberated systemd -- a fork of systemd that removes age verification support, kept up-to-date with all other upstream changes. Repo: [https://github.com/Jeffrey-Sardina/liberated-systemd](https://github.com/Jeffrey-Sardina/liberated-systemd).
